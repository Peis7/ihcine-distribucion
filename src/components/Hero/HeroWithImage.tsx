...
const HeroBannerWithImage: React.FC<HeroBannerWithImageProps> = ({
  ...
  <div className="absolute  bottom-4 h-1/2 w-full flex items-end lg:items-center px-10 text-white lg:h-full lg:w-1/2 pb-5 lg:pb-0">
    <div>
      <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold">{title}</h1>
      <h1 className="text-icblue text-2xl md:text-3xl lg:text-4xl font-bold">{title1}</h1>
      <p className="text-sm md:text-base lg:text-lg mt-2">{excerpt}</p>
    </div>
  </div>
</div>
